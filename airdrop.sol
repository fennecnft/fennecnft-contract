...
contract FennecAirdrop {
    ...
    function setBonusRate(uint256 ammout) public {
        require(
            owner == msg.sender,
    ...
    function claimFennnec() public {
        ...
        tokenInstance.transfer(msg.sender, bonus);
